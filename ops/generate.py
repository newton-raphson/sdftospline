...
def generate_and_save(iteration_number,total_iterations):
    ...
    for i in range(21000, 58000,2000):
...
def parse_args():
    ...
    parser.add_argument('--total_iterations', type=int, default=60000)
        
    return parser.parse_args()
if __name__ == '__main__':
    # take the arguments from the command line
    args = parse_args()
    generate_and_save(args.iteration_number,args.total_iterations)
